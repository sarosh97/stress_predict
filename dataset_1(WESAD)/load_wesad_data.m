...
function [data, labels_num, start_time, end_time, subjective_labels] = load_wesad_data
...
for i = 1:length(subj)
    temp1 = load(['D:\Research Papers and Data\Wearable sensing\WESAD (dataset_1)\S' num2str(subj(i)) '\S' num2str(subj(i)) '.mat']);
    data{i} = temp1.pickle_data.signal;
    
    label_data = importdata(['D:\Research Papers and Data\Wearable sensing\WESAD (dataset_1)\S' num2str(subj(i)) '\S' num2str(subj(i)) '_quest.csv']);
