...
for i = 1:length(subj)
    ...
    n_e = [((tags(tags_loc(i))-tags(1))*fs_e:(tags(tags_loc(i)+1)-tags(1))*fs_e-1)]';
...
if win_shift_e == 0.25*fs_e
    save('features_interview.mat', 'features')

elseif win_shift_e == 5*fs_e
    save('features_interview_5.mat', 'features')

elseif win_shift_e == 30*fs_e
    save('features_interview_30.mat', 'features')
end
